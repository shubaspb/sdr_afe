function VarName2 = importfile_hex(filename, startRow, endRow)
%IMPORTFILE1 Import numeric data from a text file as column vectors.
%   VARNAME2 = IMPORTFILE1(FILENAME) Reads data from text file FILENAME for
%   the default selection.
%
%   VARNAME2 = IMPORTFILE1(FILENAME, STARTROW, ENDROW) Reads data from rows
%   STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   VarName2 = importfile1('output_sig_3.dat',5, 50003);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2014/11/09 19:32:59
